...
## 本项目获取地址：https://www.bishecode.com/product/94/
...
图5-2专家管理界面【管理员可以通过选择专家管理，管理相关的专家信息记录，比如进行查看专家信息标题，修改专家信息来源等操作，专家管理界面设计如图】
![alt text](images/image-4.png)

图5-3 职位管理界面【管理员可以通过选择职位管理，管理相关的职位信息记录，比如进行查看职位详情,删除错误的职位信息,发布职位等操作，职位管理界面如图】
![alt text](images/image-5.png)

图5-4科室类型管理界面【管理员可以通过选择科室类型管理，管理相关的科室类型信息，比如查看所有科室类型,删除无用科室类型,修改科室类型,添加科室类型等操作，科室类型管理界面设计如图】
